...
export function Dialer() {
  ...
  const onSubmit = async (data: DialerFormData) => {
    ...
    try {
      // In a real app without auth, you might pass a generic identifier or nothing
      await makeCallApi(data.toNumber, data.fromNumber);
      toast({
            ...
            <Controller
                ...
                render={({ field }) => (
                    <Select onValueChange={field.onChange} value={field.value}>
                        ...
                        <SelectContent>
                            <SelectItem value="+15551234567">+1 (555) 123-4567</SelectItem>
                            <SelectItem value="+15559876543">+1 (555) 987-6543</SelectItem>
                        </SelectContent>
                    </Select>
                )}
            />
