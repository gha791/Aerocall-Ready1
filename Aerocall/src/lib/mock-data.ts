...
export const mockTeam: User[] = [
    mockUser,
    { uid: 'user-2', name: 'John Doe', email: 'john.d@example.com', avatar: 'https://placehold.co/32x32.png', role: 'Agent' },
    { uid: 'user-3', name: 'Mike Ross', email: 'mike.r@example.com', avatar: 'https://placehold.co/32x32.png', role: 'Agent' },
];
