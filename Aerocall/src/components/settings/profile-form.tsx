...
import { getUserProfileAction, updateUserProfileAction } from "@/app/settings/actions";
...
export function ProfileForm() {
  ...
  useEffect(() => {
      async function fetchProfile() {
          const { user, error } = await getUserProfileAction();
          if (error) {
              toast({ variant: 'destructive', title: 'Could not load profile', description: error });
          } else if (user) {
              form.reset({
